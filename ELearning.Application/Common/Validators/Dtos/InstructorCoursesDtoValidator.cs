// <copyright file="InstructorCoursesDtoValidator.cs" company="PlaceholderCompany">
...
public sealed class InstructorCoursesDtoValidator : AbstractValidator<InstructorCoursesDto>
{
    public InstructorCoursesDtoValidator()
    {
        ...
        this.RuleFor(x => x.Courses).NotNull();
    }
}
